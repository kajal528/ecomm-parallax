...
const Category = () => {
  return (
    <section className=' my-10 grid grid-cols-2 h-[600px] overflow-hidden'>
        <div className=' h-[600px] w-full overflow-hidden relative group/women'>
            <img src={women} alt="" height={'600'} width={'700'} className=' group-hover/women:scale-110 transition-all group-hover/women:blur-sm cursor-pointer' />
        ...
        <div className=' h-[600px] w-full overflow-hidden relative group/men'>
            <img src={men} alt="" height={'600'} width={'700'} className=' group-hover/men:scale-110 transition-all  group-hover/men:blur-sm cursor-pointer' />
